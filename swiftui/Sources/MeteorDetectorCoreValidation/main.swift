...
require(OutputKind.from(fileExtension: "jpg") == .image, "image output kind")
require(OutputKind.from(fileExtension: "mp4") == .video, "video output kind")
require(OutputKind.from(fileExtension: "json") == .data, "data output kind")
require(OutputKind.from(fileExtension: "bin") == nil, "unsupported output kind")
